    ...
    <header className="bg-gray-800 text-white p-4 flex justify-between items-center">
      ...
      <nav>
        <ul className="flex gap-4">
          ...
          <li><a href="/room-occupancy" className="hover:underline">Room Occupancy</a></li>
          <li><a href="/teacher-occupancy" className="hover:underline">Teacher Occupancy</a></li>
          <li><a href="/class-occupancy" className="hover:underline">Class Occupancy</a></li>
